...
const Properties = {
    controller: 'App\\Http\\Controllers\\Users\\Impersonate',
    properties: ['userId'],
};
const UserImpersonateController = Controller(Properties, (): JSX.Element => {
    ...
    return (
        <Overlay>
            <form {...{ onSubmit }}>
                <Modal>
                    <Header title="Impersonate user" />
                    <Content>
                        <div className=" p-10 ">
                            <div className="w-96">Are you sure you want to impersonate?</div>
                        </div>
                    </Content>
                    <Actions alignment="between">
                        ...
                        <div>
                            <Button variant="primary" type="submit" disabled={dispatching('save')}>
                                {dispatching('save') ? 'impersonating...' : 'Impersonate'}
                            </Button>
                        </div>
                    </Actions>
                </Modal>
...
export default UserImpersonateController;
