        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center my-32">
            ...
            <div className="w-full md:w-1/2">
                <div className="p-10 flex flex-col items-center md:items-start">
                    <div className="mb-10">
                        <div className="h-20 flex text-blue-600">
                            <Logo className="w-52" />
                        </div>
                    </div>
                    <h1 className="text-6xl max-w-lg text-gray-600">404</h1>
                    <h2 className="text-2xl max-w-lg text-gray-600">UH OH! You're lost.</h2>
                    <p className="max-w-lg text-gray-600 mt-4 md:text-left text-center">
                    ...
                    <div className="flex items-center pt-4 space-x-4">
                        <span>
                            <Link
                                to="/"
                                className="py-3 px-8 font-semibold text-white flex justify-center items-center flex-grow focus:outline-none rounded focus:ring-4 relative overflow-hidden shadow active:shadow-inner transition-all ease-in-out duration-200 bg-blue-500 hover:bg-blue-600 focus:ring-blue-200 active:bg-blue-800"
                            >
                                Go home
                            </Link>
                        </span>
