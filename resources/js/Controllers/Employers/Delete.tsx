...
const Properties = {
    controller: 'App\\Http\\Controllers\\Employers\\Delete',
};
const EmployerDeleteController = Controller(Properties, (): JSX.Element => {
...
export default EmployerDeleteController;
